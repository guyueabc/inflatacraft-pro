...
export const products: Product[] = [
  // ---- PRODUCT REPLICAS ----
  {
    ...
    specs: {
      ...
      sizeRange: "3ft - 30ft",
      materialOptions: ["PVC tarpaulin 210T", "Oxford nylon 210D/420D", "Cordura 500D"],
      printing: ["Dye-sublimation", "UV digital print", "Screen print"],
      blower: "Included",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "2 people",
      setupTime: "15-30 min",
      indoorOutdoor: "Both",
      anchoring: "Sandbags or stakes",
  ...
  },
  {
    ...
    specs: {
      ...
      sizeRange: "3ft - 30ft",
      materialOptions: ["PVC tarpaulin 210T", "Oxford nylon 210D/420D", "Cordura 500D"],
      printing: ["Dye-sublimation", "UV digital print"],
      blower: "Included",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "2 people",
      setupTime: "15-30 min",
  ...
  // ---- MASCOTS ----
  {
    ...
    specs: {
      ...
      sizeRange: "3ft - 10ft",
      materialOptions: ["PVC tarpaulin 210T", "Oxford nylon 210D/420D", "Cordura 500D"],
      printing: ["Dye-sublimation", "UV digital print", "Airbrush (custom finishes)"],
      blower: "Included",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
  ...
  },
  {
    ...
    specs: {
      ...
      printing: ["Solid color", "Custom logo print"],
      blower: "Included",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "1 person",
      setupTime: "2 min",
  ...
  },
  {
    ...
    specs: {
      ...
      sizeRange: "10ft - 30ft",
      materialOptions: ["500D Cordura nylon (standard)", "PVC-coated 600D (extreme use)"],
      printing: ["UV digital print with matte laminate", "Dye-sublimation"],
      blower: "3 x 1HP industrial blowers included",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "2-3 people",
      setupTime: "10-20 min",
      indoorOutdoor: "Outdoor",
      anchoring: "Heavy-duty stakes + anchor straps",
  ...
  // ---- COSTUMES ----
  {
    ...
    specs: {
      ...
      printing: ["Full-color digital print", "Sublimation"],
      blower: "Battery-powered fan (not a continuous blower)",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "1 person",
      setupTime: "2 min",
      indoorOutdoor: "Both",
  ...
  },
  {
    ...
    specs: {
      ...
      sizeRange: "One size",
      materialOptions: ["420D Oxford nylon (standard)", "Premium plush fur (upgrade)"],
      printing: ["Realistic digital print", "Airbrush detailing"],
      blower: "Battery-powered fan (not a continuous blower)",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "1 person",
      setupTime: "2 min",
  ...
  // ---- TENTS ----
  {
    ...
    specs: {
      ...
      materialOptions: ["210D Oxford nylon (economy)", "420D Oxford nylon (standard)", "500D PVC-coated (commercial)"],
      printing: ["UV digital print", "Dye-sublimation", "Full-wrap panel print"],
      blower: "1HP blower included",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "2-4 people",
      setupTime: "15-30 min",
      indoorOutdoor: "Outdoor",
      anchoring: "Stakes, water ballast bags, or weights",
  ...
  },
  {
    ...
    specs: {
      ...
      sizeRange: "10x10ft - 20x20ft",
      materialOptions: ["420D Oxford nylon (standard)", "500D PVC-coated polyester (premium)", "600D PVC-coated (extreme)"],
      printing: ["Custom exterior graphics on removable panels", "Dye-sublimation", "Vinyl applique"],
  ...
  // ---- GAMES ----
  {
    ...
    specs: {
      ...
      printing: ["UV digital print", "Dye-sublimation"],
      blower: "3 x 1.5HP industrial blowers",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "2-4 people",
      setupTime: "20-40 min",
      indoorOutdoor: "Outdoor",
      anchoring: "Heavy-duty stakes, water ballast, anchor straps",
      packing: "Multiple large storage bags + carton",
      productionTime: "3-6 weeks",
    },
    inStock: true,
    leadTime: "5-6 weeks",
  ...
  },
  {
    ...
    specs: {
      ...
      power: "110V / 750W blower",
      sizeRange: "Various",
      materialOptions: ["420D Oxford nylon (standard)", "500D PVC-coated (heavy use)"],
      printing: ["Full-color digital print", "Dye-sublimation"],
      blower: "750W blower included",
      voltageOptions: ["110V US", "220V EU", "220V UK", "220V AU"],
      setupPeople: "2-4 people",
      setupTime: "20-40 min",
      indoorOutdoor: "Both",
