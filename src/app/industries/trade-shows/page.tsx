...
export default function TradeShowsPage() {
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Industries", item: "https://qddjtx.com/industries/trade-shows" },
      { "@type": "ListItem", position: 3, name: "Trade Shows", item: "https://qddjtx.com/industries/trade-shows" },
    ],
  };
