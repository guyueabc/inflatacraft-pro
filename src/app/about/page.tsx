...
const VALUES: ValueProp[] = [
  {
    ...
    title: "Quality First",
    description:
      "Every product undergoes a mandatory 24-hour continuous inflation test before it leaves our facility. We use premium 210D–500D fabrics, reinforced double-stitched seams, and dye-sublimation printing for vibrant, long-lasting results. Zero defects is our standard.",
  },
  {
    icon: MapPin,
    title: "Made in USA",
