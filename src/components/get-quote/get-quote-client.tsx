...
export function GetQuoteClient() {
  ...
  const onSubmit = async (data: QuoteFormData) => {
    ...
    setIsSubmitted(true);
    // 鏍囪杞寲淇″彿 鈥?Analytics 缁勪欢浼氭娴嬪苟鎺ㄩ€?Google Ads 杞寲
    ...
    <div className="min-h-[calc(100vh-200px)] bg-gray-50 px-4 py-12">
      <div className="mx-auto max-w-2xl">
        <div className="mb-10 text-center">
          ...
          <p className="mt-3 text-gray-600">Just your email and phone 鈥?we&apos;ll handle the rest.</p>
        </div>
        ...
        <div className="rounded-xl border border-navy-200 bg-white p-5 shadow-sm sm:p-8">
          ...
          <div className="mb-8 rounded-lg border-2 border-red-200 bg-red-50/30 p-5">
            <p className="mb-4 text-sm font-semibold text-red-700">Required 鈥?we need these to contact you</p>
          ...
          <p className="mb-4 text-sm font-medium text-gray-400">Everything below is optional 鈥?fill in as much or as little as you like</p>
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea id="q-desc" rows={3} placeholder="Tell us about your project 鈥?what do you need?" {...form.register("description")}
