...
const PROCESS_FAQS: ProcessFAQ[] = [
  ...
  },
  {
    ...
    a: "Absolutely. Every order includes a printed setup guide and access to video tutorials. Our support team is available by WhatsApp during your first deployment. For large installations or high-profile events, we can send an on-site technician at an additional cost.",
  },
];
