      ...
      <section className="border-t border-gray-200 bg-white py-20">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mx-auto mb-10 max-w-2xl text-lg text-gray-600">
            Our team is ready to help. Reach out by WhatsApp, email, or request a
            quote — we typically respond within a few hours during business
            hours.
          </p>
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl border-2 border-green-300 px-8 py-4 text-base font-semibold text-green-700 transition-all hover:border-green-700 hover:bg-green-50 sm:w-auto"
            >
